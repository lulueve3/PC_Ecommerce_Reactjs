...
function App() {
  ...
  useEffect(() => {
    ...
    if (storedAccessToken) setIsLoggedIn(true);
      ...
      <main className="py-3">
        <Container>
          <Routes>
            ...
            <Route
              path="/login"
              element={<LoginScreen handleLoginLogout={handleLoginLogout} />}
            />
            ...
            />
            <Route path="/search/:keyword/:id?" element={<SearchScreen />} />
            ...
            />
            <Route
              path="/search/:keyword/page/:pageNumber/collection/:idCollect"
