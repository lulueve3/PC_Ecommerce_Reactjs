        ...
        <Table striped bordered hover>
            ...
            <tbody>
                {discounts?.map((discount) => {
                    const isInvalid = discount.usageLimit < 1 || new Date(discount.endTime) < new Date();
                    ...
                    return (
                        <tr key={discount.id}>
                            ...
                            <td className={discountClass}>{new Date(discount.startTime).toLocaleString()}</td>
                            <td className={discountClass}>{new Date(discount.endTime).toLocaleString()}</td>
                            <td>
                                <Button variant="info" onClick={() => handleEdit(discount)} disabled={isInvalid}>
                                    Edit
                                </Button>{' '}
                                <Button variant="warning" onClick={() => handleDisable(discount.id)} disabled={isInvalid}>
                                    Disable
                                </Button>
                            </td>
                        </tr>
