  ...
  useEffect(() => {
    const getCollections = async () => {
      ...
      const { data } = await axios.get(
        `http://mousecomputer-api.southeastasia.cloudapp.azure.com/api/admin/collections?page=0&size=100&sortBy=title&sortDirection=ASC`,
        config
      );
      console.log(data);
