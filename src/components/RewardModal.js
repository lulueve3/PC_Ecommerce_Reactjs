        ...
        <>
            <Modal show={show} onHide={onHide}>
                <Modal.Header closeButton>
                    <Modal.Title>{currentReward ? 'Edit Reward' : 'Create Reward'}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex justify-content-between">
                            <Button variant="secondary" className='m-2' onClick={() => handleCheckDiscount(rewardData.priceRuleTitle)}>
                                Check Discount
                            </Button>
                            <Button variant="primary" className='m-2' onClick={handleCreateDiscountClick}>
                                Create Discount
                            </Button>
                        </div>
